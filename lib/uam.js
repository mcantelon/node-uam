...
exports.run = function(package) {
  ...
  exports.getRegistry(function(err, registry) {
    if (registry != undefined
      ...
      && registry[package].local != undefined
      && registry[package].local.start != undefined
    ) {
...
exports.runPackage = function(package, port) {
  var command = package.local.start.replace(
    '{port}', port
  );
...
exports.loadRegistry = function(cb) {
  var tempFile = os.tmpDir() + 'uam.json';
